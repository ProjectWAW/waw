<?php
    ...
    require_once SITE_ROOT . "/services/ConflictsService.php";
    ...
    try
    {
        ...
        $service = new ConflictsService();
        $conflict = $service->Add($data["name"]);

        http_response_code(200);
        echo json_encode($conflict, JSON_THROW_ON_ERROR);
    }
    catch (Exception $e)
    {
