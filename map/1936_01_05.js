countries = [
  ...
  ["ethiopia", finland, "1936_01_05", "neutral", null],

  ["italy", italy, "1935_10_03", "italy", null],
  ["italian_ethiopia", italy_occupied, "1936_01_05", "neutral", null],
...
info_1936_01_05_1 = getCookie("info_1936_01_05_1");
marker1936_01_05_1_location = [13.622975, 39.001862];
marker1936_01_05_1 = L.marker(marker1936_01_05_1_location, {
  id: "marker1936_01_05_1",
  icon: green_biohazard,
  title: info_1936_01_05_1
});

marker_group.addLayer(marker1936_01_05_1);

mymap.addLayer(marker_group);

marker1936_01_05_1.on("click", function () {
  onClick1();
  location.href='#1936_01_05_1';
  infoClicked = document.getElementById("1936_01_05_1");
  onClick2();
});

function zoom1936_01_05_1() {
  mymap.setView(marker1936_01_05_1_location);
}
